...
screen.connect_signal('request::desktop_decoration', function(s)
  ...
  vicious.register(batwidget, vicious.widgets.bat, ' $2%')
...
effect_core.start(
  function()
    ...
    -- Add audio data if available from audio_listener
    -- if audio_listener and audio_listener.audio_data then
    --   ctx.volume = audio_listener.audio_data.volume or 0
    --   ctx.peak = audio_listener.audio_data.peak or false
    --   ctx.audio_beat = audio_listener.audio_data.beat or false
    --   ctx.fft = audio_listener.audio_data.fft or {}
    -- end
